  ...
  experience: [
    {
      ...
      bullets: [
        "Built agentic AI systems (A2UI) and tinker with the pi.dev community to automate event marketing workflows across an internal webapp, email editor, and stats assistant.",
